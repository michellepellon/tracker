...
- **`build_product` workflow: closed Gaps 2 + 4 from the #233 audit (reviewer rubric overhaul + `VerifyMilestone` reads SPEC.md)** ([#233](https://github.com/2389-research/tracker/issues/233)). PR #246 shipped the cheap trio (Gaps 1, 3, 6); this PR is the next chunk. Five more of the original 38 audit findings against `code-goblin` are now caught upfront by these two gaps, in addition to what PR #246 already catches.
